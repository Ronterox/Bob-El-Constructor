...
public class Controller : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (pf_pressedJumpTimer > 0 && p_groundDetector.groundedTimer > 0)
        {
    ...
    private void Update()
    {
        ...
        if (Input.GetButtonDown("Jump") && p_groundDetector.groundedTimer > 0) pf_pressedJumpTimer = pressedJumpTime;
    }
}
